...
class EvaluatorBuilder {
  ...
  static final class ConverterEval implements Evaluator<RecordDefinition.Property, XSElementDecl> {
    ...
    public void eval(RecordDefinition.Property target, XSElementDecl source) {
      ...
      if (converter != null) {
        ...
        target.setConverter("org.jrecordbind.converters." + target.getType() + "Converter");
      }
    }
  }
  ...
  static final class ElementTypeEval implements Evaluator<RecordDefinition.Property, XSElementDecl> {
  ...
  static final class EnumerationRestrictionEval implements Evaluator<RecordDefinition.Property, XSSimpleType> {
  ...
  static final class SimpleRestrictionEval implements Evaluator<RecordDefinition.Property, XSSimpleType> {
  ...
  static final class TypeEval implements Evaluator<RecordDefinition.Property, XSType> {
  ...
  private final List<Evaluator<RecordDefinition.Property, XSElementDecl>> propertiesEvals;
  private final List<Evaluator<RecordDefinition.Property, XSSimpleType>> simpleTypeEvaluators;
  private final List<Evaluator<RecordDefinition.Property, XSElementDecl>> simpleTypePropertiesEvals;
  ...
  public EvaluatorBuilder() {
    propertiesEvals = new LinkedList<Evaluator<RecordDefinition.Property, XSElementDecl>>();
    ...
    simpleTypeEvaluators = new LinkedList<Evaluator<RecordDefinition.Property, XSSimpleType>>();
    simpleTypeEvaluators.add(new EnumerationRestrictionEval());
    simpleTypeEvaluators.add(new SimpleRestrictionEval());

    simpleTypePropertiesEvals = new LinkedList<Evaluator<RecordDefinition.Property, XSElementDecl>>();
