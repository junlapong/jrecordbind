...
abstract class Cache<E> extends HashMap<String, E> {
  ...
  protected List<RecordDefinition.Property> collectProperties(RecordDefinition definition) {
    LinkedList<RecordDefinition.Property> properties = new LinkedList<RecordDefinition.Property>(definition.getProperties());
