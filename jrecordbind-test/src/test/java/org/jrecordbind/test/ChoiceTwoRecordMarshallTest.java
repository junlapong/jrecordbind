...
import org.jrecordbind.Marshaller;
import it.assist_si.schemas.jrb.choicetwo.Choice;
import it.assist_si.schemas.jrb.choicetwo.Four;
import it.assist_si.schemas.jrb.choicetwo.HeadTailRecord;
import it.assist_si.schemas.jrb.choicetwo.One;
import it.assist_si.schemas.jrb.choicetwo.OtherChoice;
import it.assist_si.schemas.jrb.choicetwo.Record;
import it.assist_si.schemas.jrb.choicetwo.Three;
import it.assist_si.schemas.jrb.choicetwo.Two;
...
public class ChoiceTwoRecordMarshallTest {
  ...
  public void marshallALot() throws Exception {
    ...
    assertEquals(176000, stringWriter.toString().length());
  }
  ...
  public void marshallOne() throws Exception {
    ...
    assertEquals(176, stringWriter.toString().length());
  }
