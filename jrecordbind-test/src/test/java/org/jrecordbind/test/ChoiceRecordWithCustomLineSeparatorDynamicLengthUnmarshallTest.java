...
import it.assist_si.schemas.jrb.choice_with_custom_line_separator_dynamic_length.Choice;
import it.assist_si.schemas.jrb.choice_with_custom_line_separator_dynamic_length.Record;
...
public class ChoiceRecordWithCustomLineSeparatorDynamicLengthUnmarshallTest {
  ...
  public void unmarshall() throws Exception {
    List<Record> records = unmarshaller.unmarshallAll(new InputStreamReader(
        ChoiceRecordWithCustomLineSeparatorDynamicLengthUnmarshallTest.class
            .getResourceAsStream("choice_with_custom_line_separator_dynamic_length.txt")));
