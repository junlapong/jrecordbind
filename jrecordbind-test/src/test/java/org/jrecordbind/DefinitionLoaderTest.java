...
import org.jrecordbind.RecordDefinition.Property;
...
public class DefinitionLoaderTest {
  ...
  public void choiceWithCustomSetter() throws Exception {
    ...
    assertEquals(0, subDefinition.getMinOccurs());
    assertEquals(-1, subDefinition.getMaxOccurs());
    assertEquals("org.jrecordbind.test.MyChoice", subDefinition.getClassName());
    assertEquals("choices", subDefinition.getSetterName());
    assertEquals(0, subDefinition.getProperties().size());
    assertEquals(2, subDefinition.getSubRecords().size());
    assertTrue(subDefinition.isChoice());
  ...
  public void delimiter() throws Exception {
    ...
    assertEquals("org.jrecordbind.padders.SpaceRightPadder", definition.getGlobalPadder());
  ...
  public void differentPadders() throws Exception {
    ...
    assertEquals("org.jrecordbind.converters.StringConverter", property.getConverter());
    ...
    assertEquals("org.jrecordbind.converters.IntegerConverter", property.getConverter());
    assertEquals("org.jrecordbind.padders.ZeroLeftPadder", property.getPadder());
    ...
    assertEquals("org.jrecordbind.converters.IntegerConverter", property.getConverter());
    assertEquals("org.jrecordbind.padders.SpaceRightPadder", property.getPadder());

    property = definition.getProperties().get(3);
    assertEquals("oneFloat", property.getName());
    assertEquals("Float", property.getType());
    assertEquals(10, property.getLength());
    assertEquals("org.jrecordbind.test.SimpleRecordFloatConverter", property.getConverter());
    assertNull(property.getPadder());
  }
  ...
  public void generationGap() throws Exception {
    ...
    assertEquals("org.jrecordbind.test.MyGGEnumRecord", definition.getClassName());
  }
  ...
  public void hierarchical() throws Exception {
    ...
    assertEquals("org.jrecordbind.test.SimpleRecordDateConverter", property.getConverter());
  }
  ...
  public void simple() throws Exception {
    ...
    assertEquals("org.jrecordbind.test.YNBooleanConverter", property.getConverter());
  }
  ...
  public void enumWithRestrictions() throws Exception {
    ...
    assertEquals(10, property.getLength());
    assertEquals("org.jrecordbind.converters.EnumConverter", property.getConverter());
