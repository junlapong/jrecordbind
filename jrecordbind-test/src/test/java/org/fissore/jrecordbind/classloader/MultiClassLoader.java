package org.fissore.jrecordbind.classloader;
...
public class MultiClassLoader {
  ...
  public static void init() {
    File file = Maven.configureResolver()
        ...
        .resolve("org.fissore.jrecordbind:jrecordbind-pojo:2.3.9-SNAPSHOT")
  ...
  public void testUnmarshallWithClassLoader() {
    ...
    Assert.assertEquals("org.fissore.jrecordbind.classloader.domain.ClassLoaderRecord", object.getClass().getName());
  ...
  private Object createRecordObject() throws ClassNotFoundException, InstantiationException, IllegalAccessException, InvocationTargetException {
    ...
    Class<?> recordClass = classLoader.loadClass("org.fissore.jrecordbind.classloader.domain.ClassLoaderRecord");
