...
import org.jrecordbind.schemas.jrb.hierarchical_variable_length.ChildRecord;
import org.jrecordbind.schemas.jrb.hierarchical_variable_length.MasterRecord;
import org.jrecordbind.schemas.jrb.hierarchical_variable_length.RowChildRecord;
import org.jrecordbind.schemas.jrb.hierarchical_variable_length.RowRecord;
...
public class HierarchicalDynamicLengthRecordMarshallTest {
  ...
  public void marshallALot() throws Exception {
    ...
    assertEquals(69000, stringWriter.toString().length());
  }
  ...
  public void marshallOne() throws Exception {
    ...
    assertEquals(69, stringWriter.toString().length());
  }
